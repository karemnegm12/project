...
class MobileCarRentalcheckOut extends StatefulWidget {
  const MobileCarRentalcheckOut({super.key});

  @override
  State<MobileCarRentalcheckOut> createState() =>
      _MobileCarRentalcheckOutState();
}

class _MobileCarRentalcheckOutState extends State<MobileCarRentalcheckOut> {
        ...
        body: Container(
          child: Theme(
            data: Theme.of(context).copyWith(
                colorScheme:
                    const ColorScheme.light(primary: Color(0xff203351))),
            child: Stepper(
