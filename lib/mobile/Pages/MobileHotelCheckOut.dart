...
class MobileHotelcheckOut extends StatefulWidget {
  const MobileHotelcheckOut({super.key});

  @override
  State<MobileHotelcheckOut> createState() => _MobileHotelcheckOutState();
}

class _MobileHotelcheckOutState extends State<MobileHotelcheckOut> {
  int currentSteps = 0;
  List<Step> getsteps() => [
        Step(
