...
class MobileSaudi extends StatefulWidget {
  const MobileSaudi({super.key});

  @override
  State<MobileSaudi> createState() => _MobileSaudiState();
}

class _MobileSaudiState extends State<MobileSaudi> {
  @override
