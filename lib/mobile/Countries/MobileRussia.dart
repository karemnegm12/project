...
class MobileRussia extends StatefulWidget {
  const MobileRussia({super.key});

  @override
  State<MobileRussia> createState() => _MobileRussiaState();
}

class _MobileRussiaState extends State<MobileRussia> {
  @override
