...
class MobileItaly extends StatefulWidget {
  const MobileItaly({super.key});

  @override
  State<MobileItaly> createState() => _MobileItalyState();
}

class _MobileItalyState extends State<MobileItaly> {
  @override
